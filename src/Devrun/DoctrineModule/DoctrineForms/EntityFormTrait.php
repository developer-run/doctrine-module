...
use Devrun\DoctrineModule\NotImplementedException;
use Nette;
...
trait EntityFormTrait
{
    ...
    public function getEntityMapper()
    {
        if ($this->entityMapper === NULL) {
            $this->entityMapper = $this->getServiceLocator()->getByType('Devrun\DoctrineModule\DoctrineForms\EntityFormMapper');
        }
     ...
     * @return EntityFormTrait|UI\Form
     */
    public function _injectBuilderFactory(BuilderFactory $factory)
    {
    ...
    public function fireEvents()
    {
        ...
        if ($this->isValid()) {
            ...
            if ($this->entity) $this->getEntityMapper()->save($this->entity, $this);
